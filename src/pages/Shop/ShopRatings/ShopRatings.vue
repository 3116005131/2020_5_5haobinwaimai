    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on: onlyShowText}" @click="toggleOnlyShowText">
          <span class="iconfont iconsuccess-fill"></span>
        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0 ? 'icongood-fill' : 'iconbad-fill'"></span>
...
export default {
  ...
  mounted () {
    this.$store.dispatch('getShopRatings', () => {
      this.$nextTick(() => {
        let bscroll4 = new BScroll(this.$refs.ratings, {
          click: true
        })
        bscroll4.enabled = true
      })
    })
  },
      ...
      .rating-item
        ...
        .content
          ...
          .text
            ...
            font-size: 12px
          .recommend
            .icongood-fill, .iconbad-fill, .item
              margin: 0 8px 4px 0
              font-size: 9px
            .icongood-fill
              color: $yellow
