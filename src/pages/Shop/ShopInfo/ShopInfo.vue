...
export default {
  data () {
    return {
      supportClasses: ['activity-yellow', 'activity-red', 'activity-orange']
    }
  },
  ...
  methods: {
    _initScroll () {
      let bscroll2 = new BScroll('.shop-info')
      bscroll2.enabled = true
      //  动态计算ul的宽度
      ...
      let bscroll3 = new BScroll('.pic-wrapper', {
        scrollX: true // 水平滑动
      })
      bscroll3.enabled = true
    }
  },
